...
export const PREFECTURE_SPOTS: Record<Prefecture, Array<Spot>> = {
  [Prefecture.JP_01]: [Spot.HAKODATE_NIGHT, Spot.SUSUKINO_FU, Spot.SAPPORO_RAMEN],
  [Prefecture.JP_02]: [],
  [Prefecture.JP_03]: [],
  ...
  [Prefecture.JP_26]: [Spot.AMANOHASHIDATE_VIEW, Spot.MIYAMA_VILLAGE, Spot.HEIAN_JINGU, Spot.GION_MATSURI, Spot.KITANO_TEN, Spot.UJI_TEA],
  [Prefecture.JP_27]: [Spot.OSAKA_CASTLE, Spot.TENJIN_MATSURI],
  [Prefecture.JP_28]: [Spot.MAYA_NIGHT, Spot.ARIMA_SPRING, Spot.NANKIN_CH, Spot.KOBE_COW],
  [Prefecture.JP_29]: [],
